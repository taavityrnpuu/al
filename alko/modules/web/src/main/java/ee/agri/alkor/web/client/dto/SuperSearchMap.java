...
public class SuperSearchMap extends ABaseDTOMap {
	...
	public static final String PRODUCT_BOTTLE_COLOR = "productBottleColor";
	public static final String PRODUCT_CORK_MATERIAL = "productCorkMaterial";
	public static final String PRODUCT_CORK_COLOR = "productCorkColor";
	public static final String PRODUCT_CORK_SHAPE = "productCorkShape";
	public static final String PRODUCT_STOCKING_COLOR = "productStockingColor";
