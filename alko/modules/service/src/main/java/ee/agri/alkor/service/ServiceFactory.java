...
public class ServiceFactory {
	...
	public static IClassificatorService
		getClassificatorService() {
		return ((ClassificatorServiceDelegate) getAppContext().
        		getBean("classServiceDelegate")).getService();
	}
	 public static IUserManagerService 
	 	getUserManagerService() {
		 return ((UserManagerServiceDelegate) getAppContext().
	        		getBean("userServiceDelegate")).getService();		 
	 }
	 public static IRegistryService 
	 	getRegistryService() {
		 return ((RegistryServiceDelegate) getAppContext().
	        		getBean("registryServiceDelegate")).getService();		 
	 }
	 
	 public static IExternalService 
	 	getExternalService() {
		 return ((IExternalService) getAppContext().
	        		getBean("erService"));		 
	 }
