...
public class TegevusType_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TegevusType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mtr.x-road.ee/producer/", "tegevusType"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://mtr.x-road.ee/producer/", "tegevusTyypType"));
        typeDesc.addFieldDesc(attrField);
