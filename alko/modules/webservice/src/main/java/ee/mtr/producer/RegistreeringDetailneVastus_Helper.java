/**
 * RegistreeringDetailneVastus_Helper.java
 *
...
public class RegistreeringDetailneVastus_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegistreeringDetailneVastus.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mtr.x-road.ee/producer/", "RegistreeringDetailneVastus"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://mtr.x-road.ee/producer/", "registrikanneDetailneTegevusType"));
