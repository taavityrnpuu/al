...
public class CountryType implements java.io.Serializable {
    ...
    public static final java.lang.String _value1 = "$country.code";
    public static final CountryType value1 = new CountryType(_value1);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://producers.alkor2.xtee.riik.ee/producer/alkor2", "CountryType"));
    }
    /**
