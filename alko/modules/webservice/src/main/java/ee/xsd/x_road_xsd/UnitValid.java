...
public class UnitValid  implements java.io.Serializable {
    private ee.x_road.xsd.x_road_xsd.UnitValidRequest request;

    public UnitValid() {
    }

    public UnitValid(
           ee.x_road.xsd.x_road_xsd.UnitValidRequest request) {
     ...
     * @return request
     */
    public ee.x_road.xsd.x_road_xsd.UnitValidRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(ee.x_road.xsd.x_road_xsd.UnitValidRequest request) {
        this.request = request;
    }
