...
public class UnitRepresentResponse  implements java.io.Serializable {
    private ee.x_road.xsd.x_road_xsd.UnitRepresentResponseRequest request;

    private ee.x_road.xsd.x_road_xsd.UnitRepresentResponseResponseItem[] response;

    public UnitRepresentResponse() {
    }

    public UnitRepresentResponse(
           ee.x_road.xsd.x_road_xsd.UnitRepresentResponseRequest request,
           ee.x_road.xsd.x_road_xsd.UnitRepresentResponseResponseItem[] response) {
     ...
     * @return request
     */
    public ee.x_road.xsd.x_road_xsd.UnitRepresentResponseRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(ee.x_road.xsd.x_road_xsd.UnitRepresentResponseRequest request) {
        this.request = request;
    }
     ...
     * @return response
     */
    public ee.x_road.xsd.x_road_xsd.UnitRepresentResponseResponseItem[] getResponse() {
        return response;
    }
     ...
     * @param response
     */
    public void setResponse(ee.x_road.xsd.x_road_xsd.UnitRepresentResponseResponseItem[] response) {
        this.response = response;
    }
