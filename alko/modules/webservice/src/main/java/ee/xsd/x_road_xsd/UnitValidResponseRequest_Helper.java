/**
 * UnitValidResponseRequest_Helper.java
 *
...
public class UnitValidResponseRequest_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UnitValidResponseRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://x-road.ee/xsd/x-road.xsd", ">unitValidResponse>request"));
