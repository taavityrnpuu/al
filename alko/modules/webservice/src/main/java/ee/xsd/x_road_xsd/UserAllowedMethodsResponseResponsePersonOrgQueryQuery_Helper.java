/**
 * UserAllowedMethodsResponseResponsePersonOrgQueryQuery_Helper.java
 *
...
public class UserAllowedMethodsResponseResponsePersonOrgQueryQuery_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UserAllowedMethodsResponseResponsePersonOrgQueryQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://x-road.ee/xsd/x-road.xsd", ">>>>>userAllowedMethodsResponse>response>person>orgQuery>query"));
