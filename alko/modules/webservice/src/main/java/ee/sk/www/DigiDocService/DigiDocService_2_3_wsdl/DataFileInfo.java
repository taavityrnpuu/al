...
public class DataFileInfo  implements java.io.Serializable {
    ...
    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileAttribute[] attributes;
    ...
    public DataFileInfo(
           ...
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileAttribute[] attributes) {
           this.id = id;
     ...
     * @return attributes
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileAttribute[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileAttribute[] attributes) {
        this.attributes = attributes;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileAttribute getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileAttribute _value) {
