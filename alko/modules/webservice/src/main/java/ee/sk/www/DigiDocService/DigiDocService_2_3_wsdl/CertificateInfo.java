...
public class CertificateInfo  implements java.io.Serializable {
    ...
    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CertificatePolicy[] policies;
    ...
    public CertificateInfo(
           ...
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CertificatePolicy[] policies) {
           this.issuer = issuer;
     ...
     * @return policies
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CertificatePolicy[] getPolicies() {
        return policies;
    }
     ...
     * @param policies
     */
    public void setPolicies(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CertificatePolicy[] policies) {
        this.policies = policies;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CertificatePolicy getPolicies(int i) {
        return this.policies[i];
    }

    public void setPolicies(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CertificatePolicy _value) {
