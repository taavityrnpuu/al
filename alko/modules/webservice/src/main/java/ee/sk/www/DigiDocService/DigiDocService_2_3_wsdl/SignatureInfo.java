...
public class SignatureInfo  implements java.io.Serializable {
    ...
    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.Error error;

    private java.util.Calendar signingTime;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerRole[] signerRole;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureProductionPlace signatureProductionPlace;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerInfo signer;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.ConfirmationInfo confirmation;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.TstInfo[] timestamps;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CRLInfo CRLInfo;
    ...
    public SignatureInfo(
           ...
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.Error error,
           java.util.Calendar signingTime,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerRole[] signerRole,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureProductionPlace signatureProductionPlace,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerInfo signer,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.ConfirmationInfo confirmation,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.TstInfo[] timestamps,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CRLInfo CRLInfo) {
           this.id = id;
           this.status = status;
           this.error = error;
     ...
     * @return error
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.Error getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.Error error) {
        this.error = error;
    }
     ...
     * @return signerRole
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerRole[] getSignerRole() {
        return signerRole;
    }
     ...
     * @param signerRole
     */
    public void setSignerRole(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerRole[] signerRole) {
        this.signerRole = signerRole;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerRole getSignerRole(int i) {
        return this.signerRole[i];
    }

    public void setSignerRole(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerRole _value) {
     ...
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureProductionPlace getSignatureProductionPlace() {
        return signatureProductionPlace;
    }
     ...
     */
    public void setSignatureProductionPlace(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureProductionPlace signatureProductionPlace) {
        this.signatureProductionPlace = signatureProductionPlace;
    }
     ...
     * @return signer
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerInfo getSigner() {
        return signer;
    }
     ...
     * @param signer
     */
    public void setSigner(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignerInfo signer) {
        this.signer = signer;
    }
     ...
     * @return confirmation
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.ConfirmationInfo getConfirmation() {
        return confirmation;
    }
     ...
     * @param confirmation
     */
    public void setConfirmation(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.ConfirmationInfo confirmation) {
        this.confirmation = confirmation;
    }
     ...
     * @return timestamps
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.TstInfo[] getTimestamps() {
        return timestamps;
    }
     ...
     * @param timestamps
     */
    public void setTimestamps(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.TstInfo[] timestamps) {
        this.timestamps = timestamps;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.TstInfo getTimestamps(int i) {
        return this.timestamps[i];
    }

    public void setTimestamps(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.TstInfo _value) {
     ...
     * @return CRLInfo
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CRLInfo getCRLInfo() {
        return CRLInfo;
    }
     ...
     * @param CRLInfo
     */
    public void setCRLInfo(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.CRLInfo CRLInfo) {
        this.CRLInfo = CRLInfo;
    }
