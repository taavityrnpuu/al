...
public class CRLInfo  implements java.io.Serializable {
    ...
    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.RevokedInfo[] revocations;
    ...
    public CRLInfo(
           ...
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.RevokedInfo[] revocations) {
           this.issuer = issuer;
     ...
     * @return revocations
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.RevokedInfo[] getRevocations() {
        return revocations;
    }
     ...
     * @param revocations
     */
    public void setRevocations(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.RevokedInfo[] revocations) {
        this.revocations = revocations;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.RevokedInfo getRevocations(int i) {
        return this.revocations[i];
    }

    public void setRevocations(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.RevokedInfo _value) {
