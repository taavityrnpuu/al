...
public class SignedDocInfo  implements java.io.Serializable {
    ...
    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileInfo[] dataFileInfo;

    private ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureInfo[] signatureInfo;
    ...
    public SignedDocInfo(
           ...
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileInfo[] dataFileInfo,
           ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureInfo[] signatureInfo) {
           this.format = format;
     ...
     * @return dataFileInfo
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileInfo[] getDataFileInfo() {
        return dataFileInfo;
    }
     ...
     * @param dataFileInfo
     */
    public void setDataFileInfo(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileInfo[] dataFileInfo) {
        this.dataFileInfo = dataFileInfo;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileInfo getDataFileInfo(int i) {
        return this.dataFileInfo[i];
    }

    public void setDataFileInfo(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.DataFileInfo _value) {
     ...
     */
    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureInfo[] getSignatureInfo() {
        return signatureInfo;
    }
     ...
     * @param signatureInfo
     */
    public void setSignatureInfo(ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureInfo[] signatureInfo) {
        this.signatureInfo = signatureInfo;
    }

    public ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureInfo getSignatureInfo(int i) {
        return this.signatureInfo[i];
    }

    public void setSignatureInfo(int i, ee.sk.www.DigiDocService.DigiDocService_2_3_wsdl.SignatureInfo _value) {
