...
public class Treasury  implements java.io.Serializable {
    ...
    /* Tehingu Riigikassapoolne unikaalne töökood
     * 								(arhiveerimistunnus). */
     ...
     * 
     * @return orderNum   * Tehingu Riigikassapoolne unikaalne töökood
     * 								(arhiveerimistunnus).
     */
     ...
     * 
     * @param orderNum   * Tehingu Riigikassapoolne unikaalne töökood
     * 								(arhiveerimistunnus).
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rm-v6.x-road.eu/treasury/customer", "Treasury"));
