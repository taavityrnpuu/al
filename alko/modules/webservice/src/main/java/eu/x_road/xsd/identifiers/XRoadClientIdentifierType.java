...
public class XRoadClientIdentifierType  extends eu.x_road.xsd.identifiers.XRoadIdentifierType  implements java.io.Serializable {
    public XRoadClientIdentifierType() {
    }

    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(XRoadClientIdentifierType.class, false);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://x-road.eu/xsd/identifiers", "XRoadClientIdentifierType"));
