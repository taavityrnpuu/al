...
public class TooteparingResponse  implements java.io.Serializable {
    private java.lang.String teade;

    private eu.x_road.alkor2.types.Tooteparing_vastuserida[] tooted;

    private java.lang.String tooted_csv;

    public TooteparingResponse() {
    }

    public TooteparingResponse(
           java.lang.String teade,
           eu.x_road.alkor2.types.Tooteparing_vastuserida[] tooted,
    ...
    /**
     * Gets the teade value for this TooteparingResponse.
     * 
     * @return teade
     */
    ...
    /**
     * Sets the teade value for this TooteparingResponse.
     * 
     * @param teade
     */
    ...
    /**
     * Gets the tooted value for this TooteparingResponse.
     * 
     * @return tooted
     */
    public eu.x_road.alkor2.types.Tooteparing_vastuserida[] getTooted() {
        return tooted;
    }


    /**
     * Sets the tooted value for this TooteparingResponse.
     * 
     * @param tooted
     */
    public void setTooted(eu.x_road.alkor2.types.Tooteparing_vastuserida[] tooted) {
        this.tooted = tooted;
    }


    /**
     * Gets the tooted_csv value for this TooteparingResponse.
     * 
     * @return tooted_csv
     */
    ...
    /**
     * Sets the tooted_csv value for this TooteparingResponse.
     * 
     * @param tooted_csv
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TooteparingResponse)) return false;
        TooteparingResponse other = (TooteparingResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TooteparingResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", ">tooteparingResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "tooteparing_vastuserida"));
