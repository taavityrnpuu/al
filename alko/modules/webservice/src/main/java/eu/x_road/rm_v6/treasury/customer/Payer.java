...
public class Payer  implements java.io.Serializable {
    ...
    /* Maksja id.-kood (isikukood, asutuse/ettevõtte reg.
     * 								nr.). */
     ...
     * 
     * @return regNum   * Maksja id.-kood (isikukood, asutuse/ettevõtte reg.
     * 								nr.).
     */
     ...
     * 
     * @param regNum   * Maksja id.-kood (isikukood, asutuse/ettevõtte reg.
     * 								nr.).
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rm-v6.x-road.eu/treasury/customer", "Payer"));
