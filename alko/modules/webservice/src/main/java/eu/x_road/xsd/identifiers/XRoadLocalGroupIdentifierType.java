...
public class XRoadLocalGroupIdentifierType  extends eu.x_road.xsd.identifiers.XRoadIdentifierType  implements java.io.Serializable {
    public XRoadLocalGroupIdentifierType() {
    }

    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(XRoadLocalGroupIdentifierType.class, false);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://x-road.eu/xsd/identifiers", "XRoadLocalGroupIdentifierType"));
