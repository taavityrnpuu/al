...
public class PaymentType implements java.io.Serializable {
    ...
    public static final PaymentType C = new PaymentType(_C);
    public static final PaymentType D = new PaymentType(_D);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://arireg.x-road.eu/producer/", ">Payment>Type"));
    }
    /**
