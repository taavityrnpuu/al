...
public class MokaQueryType  implements java.io.Serializable {
    private eu.x_road.rm_v6.treasury.customer.MokaType moka;

    public MokaQueryType() {
    }

    public MokaQueryType(
           eu.x_road.rm_v6.treasury.customer.MokaType moka) {
           this.moka = moka;
    }
     ...
     * @return moka
     */
    public eu.x_road.rm_v6.treasury.customer.MokaType getMoka() {
        return moka;
    }
     ...
     * @param moka
     */
    public void setMoka(eu.x_road.rm_v6.treasury.customer.MokaType moka) {
        this.moka = moka;
    }
