/**
 * Erakondakuuluvus_liige_Helper.java
 *
...
public class Erakondakuuluvus_liige_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Erakondakuuluvus_liige.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://arireg.x-road.eu/producer/", "erakondakuuluvus_liige"));
