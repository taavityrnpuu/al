...
public class Paringliht_tasuta_vastus  implements java.io.Serializable {
    private eu.x_road.arireg.producer.Paringliht_tasuta_ettevote[] ettevotjad;

    private java.math.BigInteger leitud_ettevotjate_arv;

    public Paringliht_tasuta_vastus() {
    }

    public Paringliht_tasuta_vastus(
           eu.x_road.arireg.producer.Paringliht_tasuta_ettevote[] ettevotjad,
    ...
    /**
     * Gets the ettevotjad value for this Paringliht_tasuta_vastus.
     * 
     * @return ettevotjad
     */
    public eu.x_road.arireg.producer.Paringliht_tasuta_ettevote[] getEttevotjad() {
        return ettevotjad;
    }


    /**
     * Sets the ettevotjad value for this Paringliht_tasuta_vastus.
     * 
     * @param ettevotjad
     */
    public void setEttevotjad(eu.x_road.arireg.producer.Paringliht_tasuta_ettevote[] ettevotjad) {
        this.ettevotjad = ettevotjad;
    }


    /**
     * Gets the leitud_ettevotjate_arv value for this Paringliht_tasuta_vastus.
     * 
    ...
    /**
     * Sets the leitud_ettevotjate_arv value for this Paringliht_tasuta_vastus.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Paringliht_tasuta_vastus)) return false;
        Paringliht_tasuta_vastus other = (Paringliht_tasuta_vastus) obj;
