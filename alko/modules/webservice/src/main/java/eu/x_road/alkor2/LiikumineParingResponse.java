...
public class LiikumineParingResponse  implements java.io.Serializable {
    ...
    private eu.x_road.alkor2.Liikumine[] liikumised;
    ...
    public LiikumineParingResponse(
           ...
           eu.x_road.alkor2.Liikumine[] liikumised,
     ...
     * @return liikumised
     */
    public eu.x_road.alkor2.Liikumine[] getLiikumised() {
        return liikumised;
    }
     ...
     * @param liikumised
     */
    public void setLiikumised(eu.x_road.alkor2.Liikumine[] liikumised) {
        this.liikumised = liikumised;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", ">liikumineParingResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", "liikumine"));
