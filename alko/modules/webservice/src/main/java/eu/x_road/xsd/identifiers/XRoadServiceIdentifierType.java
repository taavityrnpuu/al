...
public class XRoadServiceIdentifierType  extends eu.x_road.xsd.identifiers.XRoadIdentifierType  implements java.io.Serializable {
    public XRoadServiceIdentifierType() {
    }

    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(XRoadServiceIdentifierType.class, false);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://x-road.eu/xsd/identifiers", "XRoadServiceIdentifierType"));
