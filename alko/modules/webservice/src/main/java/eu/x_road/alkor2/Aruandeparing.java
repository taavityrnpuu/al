...
public class Aruandeparing  implements java.io.Serializable {
    private java.util.Date l_date_from;

    private java.util.Date l_date_to;

    private eu.x_road.alkor2.Aruandeperiood periodStart;

    private eu.x_road.alkor2.Aruandeperiood periodEnd;

    private boolean resp_attach;

    public Aruandeparing() {
    }

    public Aruandeparing(
           java.util.Date l_date_from,
           java.util.Date l_date_to,
           eu.x_road.alkor2.Aruandeperiood periodStart,
           eu.x_road.alkor2.Aruandeperiood periodEnd,
           boolean resp_attach) {
    ...
    /**
     * Gets the l_date_from value for this Aruandeparing.
     * 
     * @return l_date_from
     */
    ...
    /**
     * Sets the l_date_from value for this Aruandeparing.
     * 
     * @param l_date_from
     */
    ...
    /**
     * Gets the l_date_to value for this Aruandeparing.
     * 
     * @return l_date_to
     */
    ...
    /**
     * Sets the l_date_to value for this Aruandeparing.
     * 
     * @param l_date_to
     */
    ...
    /**
     * Gets the periodStart value for this Aruandeparing.
     * 
     * @return periodStart
     */
    public eu.x_road.alkor2.Aruandeperiood getPeriodStart() {
        return periodStart;
    }


    /**
     * Sets the periodStart value for this Aruandeparing.
     * 
     * @param periodStart
     */
    public void setPeriodStart(eu.x_road.alkor2.Aruandeperiood periodStart) {
        this.periodStart = periodStart;
    }


    /**
     * Gets the periodEnd value for this Aruandeparing.
     * 
     * @return periodEnd
     */
    public eu.x_road.alkor2.Aruandeperiood getPeriodEnd() {
        return periodEnd;
    }


    /**
     * Sets the periodEnd value for this Aruandeparing.
     * 
     * @param periodEnd
     */
    public void setPeriodEnd(eu.x_road.alkor2.Aruandeperiood periodEnd) {
        this.periodEnd = periodEnd;
    }


    /**
     * Gets the resp_attach value for this Aruandeparing.
     * 
     * @return resp_attach
     */
    ...
    /**
     * Sets the resp_attach value for this Aruandeparing.
     * 
     * @param resp_attach
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Aruandeparing)) return false;
        Aruandeparing other = (Aruandeparing) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Aruandeparing.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", ">aruandeparing"));
