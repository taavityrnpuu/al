...
public class Fault  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private eu.x_road.alkor2.Detail detail;
    ...
    public Fault(
           ...
           eu.x_road.alkor2.Detail detail) {
     ...
     * @return detail
     */
    public eu.x_road.alkor2.Detail getDetail() {
        return detail;
    }
     ...
     * @param detail
     */
    public void setDetail(eu.x_road.alkor2.Detail detail) {
        this.detail = detail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", ">Fault"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", "detail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
