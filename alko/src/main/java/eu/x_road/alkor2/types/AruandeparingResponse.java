...
public class AruandeparingResponse  implements java.io.Serializable {
    ...
    private eu.x_road.alkor2.types.Aruandeparing_vastuserida[] aruanded;
    ...
    public AruandeparingResponse(
           ...
           eu.x_road.alkor2.types.Aruandeparing_vastuserida[] aruanded,
     ...
     * @return aruanded
     */
    public eu.x_road.alkor2.types.Aruandeparing_vastuserida[] getAruanded() {
        return aruanded;
    }
     ...
     * @param aruanded
     */
    public void setAruanded(eu.x_road.alkor2.types.Aruandeparing_vastuserida[] aruanded) {
        this.aruanded = aruanded;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", ">aruandeparingResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "aruandeparing_vastuserida"));
