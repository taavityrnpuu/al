...
public class MokaType  implements java.io.Serializable {
    private eu.x_road.alkor2.types.Treasury treasury;

    private eu.x_road.alkor2.types.Payer payer;

    private eu.x_road.alkor2.types.Receiver receiver;

    private eu.x_road.alkor2.types.Payment payment;
    ...
    public MokaType(
           eu.x_road.alkor2.types.Treasury treasury,
           eu.x_road.alkor2.types.Payer payer,
           eu.x_road.alkor2.types.Receiver receiver,
           eu.x_road.alkor2.types.Payment payment,
     ...
     * @return treasury
     */
    public eu.x_road.alkor2.types.Treasury getTreasury() {
        return treasury;
    }
     ...
     * @param treasury
     */
    public void setTreasury(eu.x_road.alkor2.types.Treasury treasury) {
        this.treasury = treasury;
    }
     ...
     * @return payer
     */
    public eu.x_road.alkor2.types.Payer getPayer() {
        return payer;
    }
     ...
     * @param payer
     */
    public void setPayer(eu.x_road.alkor2.types.Payer payer) {
        this.payer = payer;
    }
     ...
     * @return receiver
     */
    public eu.x_road.alkor2.types.Receiver getReceiver() {
        return receiver;
    }
     ...
     * @param receiver
     */
    public void setReceiver(eu.x_road.alkor2.types.Receiver receiver) {
        this.receiver = receiver;
    }
     ...
     * @return payment
     */
    public eu.x_road.alkor2.types.Payment getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(eu.x_road.alkor2.types.Payment payment) {
        this.payment = payment;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "MokaType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("treasury");
        elemField.setXmlName(new javax.xml.namespace.QName("", "Treasury"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "Treasury"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payer");
        elemField.setXmlName(new javax.xml.namespace.QName("", "Payer"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "Payer"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("receiver");
        elemField.setXmlName(new javax.xml.namespace.QName("", "Receiver"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "Receiver"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payment");
        elemField.setXmlName(new javax.xml.namespace.QName("", "Payment"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "Payment"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
