...
public class Tooteparing  implements java.io.Serializable {
    ...
    private eu.x_road.alkor2.types.Tooteliik producttype;

    private java.lang.String man_actor_name;

    private eu.x_road.alkor2.types.CountryType country;

    private eu.x_road.alkor2.types.CapacityType volume;
     ...
     * @return producttype
     */
    public eu.x_road.alkor2.types.Tooteliik getProducttype() {
        return producttype;
    }
     ...
     * @param producttype
     */
    public void setProducttype(eu.x_road.alkor2.types.Tooteliik producttype) {
        this.producttype = producttype;
    }
     ...
     * @return country
     */
    public eu.x_road.alkor2.types.CountryType getCountry() {
        return country;
    }
     ...
     * @param country
     */
    public void setCountry(eu.x_road.alkor2.types.CountryType country) {
        this.country = country;
    }
     ...
     * @return volume
     */
    public eu.x_road.alkor2.types.CapacityType getVolume() {
        return volume;
    }
     ...
     * @param volume
     */
    public void setVolume(eu.x_road.alkor2.types.CapacityType volume) {
        this.volume = volume;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", ">tooteparing"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "tooteliik"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "CountryType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "CapacityType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
