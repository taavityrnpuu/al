...
public class Aretolaadib  implements java.io.Serializable {
    private eu.x_road.alkor2.types.Aruandjakoodigaareto aruandja;
     ...
     * @return aruandja
     */
    public eu.x_road.alkor2.types.Aruandjakoodigaareto getAruandja() {
        return aruandja;
    }
     ...
     * @param aruandja
     */
    public void setAruandja(eu.x_road.alkor2.types.Aruandjakoodigaareto aruandja) {
        this.aruandja = aruandja;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", ">aretolaadib"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("aruandja");
        elemField.setXmlName(new javax.xml.namespace.QName("", "aruandja"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", "aruandjakoodigaareto"));
