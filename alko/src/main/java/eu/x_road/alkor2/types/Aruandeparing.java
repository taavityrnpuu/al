...
public class Aruandeparing  implements java.io.Serializable {
    ...
    private eu.x_road.alkor2.types.Aruandeperiood periodStart;

    private eu.x_road.alkor2.types.Aruandeperiood periodEnd;
     ...
     * @return periodStart
     */
    public eu.x_road.alkor2.types.Aruandeperiood getPeriodStart() {
        return periodStart;
    }
     ...
     * @param periodStart
     */
    public void setPeriodStart(eu.x_road.alkor2.types.Aruandeperiood periodStart) {
        this.periodStart = periodStart;
    }
     ...
     * @return periodEnd
     */
    public eu.x_road.alkor2.types.Aruandeperiood getPeriodEnd() {
        return periodEnd;
    }
     ...
     * @param periodEnd
     */
    public void setPeriodEnd(eu.x_road.alkor2.types.Aruandeperiood periodEnd) {
        this.periodEnd = periodEnd;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/types", ">aruandeparing"));
