...
public class TooteparingResponse  implements java.io.Serializable {
    ...
    private eu.x_road.alkor2.Tooteparing_vastuserida[] tooted;
    ...
    public TooteparingResponse(
           ...
           eu.x_road.alkor2.Tooteparing_vastuserida[] tooted,
     ...
     * @return tooted
     */
    public eu.x_road.alkor2.Tooteparing_vastuserida[] getTooted() {
        return tooted;
    }
     ...
     * @param tooted
     */
    public void setTooted(eu.x_road.alkor2.Tooteparing_vastuserida[] tooted) {
        this.tooted = tooted;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", ">tooteparingResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://alkor2.x-road.eu/", "tooteparing_vastuserida"));
