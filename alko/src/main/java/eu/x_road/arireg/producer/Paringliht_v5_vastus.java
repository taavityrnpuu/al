...
public class Paringliht_v5_vastus  implements java.io.Serializable {
    private eu.x_road.arireg.producer.Paringliht_v5_ettevote[] ettevotjad;

    private java.math.BigInteger leitud_ettevotjate_arv;

    public Paringliht_v5_vastus() {
    }

    public Paringliht_v5_vastus(
           eu.x_road.arireg.producer.Paringliht_v5_ettevote[] ettevotjad,
    ...
    /**
     * Gets the ettevotjad value for this Paringliht_v5_vastus.
     * 
     * @return ettevotjad
     */
    public eu.x_road.arireg.producer.Paringliht_v5_ettevote[] getEttevotjad() {
        return ettevotjad;
    }


    /**
     * Sets the ettevotjad value for this Paringliht_v5_vastus.
     * 
     * @param ettevotjad
     */
    public void setEttevotjad(eu.x_road.arireg.producer.Paringliht_v5_ettevote[] ettevotjad) {
        this.ettevotjad = ettevotjad;
    }


    /**
     * Gets the leitud_ettevotjate_arv value for this Paringliht_v5_vastus.
     * 
    ...
    /**
     * Sets the leitud_ettevotjate_arv value for this Paringliht_v5_vastus.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Paringliht_v5_vastus)) return false;
        Paringliht_v5_vastus other = (Paringliht_v5_vastus) obj;
