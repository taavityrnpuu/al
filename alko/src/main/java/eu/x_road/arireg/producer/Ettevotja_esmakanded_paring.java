/**
 * Ettevotja_esmakanded_paring.java
 *
...
public class Ettevotja_esmakanded_paring  implements java.io.Serializable {
    private java.lang.String ariregister_kasutajanimi;

    private java.lang.String ariregister_parool;

    /* Millise kuupäeva kohta ettevõtja esmakandeid päritakse. */
    private java.util.Date kuupaev;

    public Ettevotja_esmakanded_paring() {
    }
    ...
    /**
     * Gets the ariregister_kasutajanimi value for this Ettevotja_esmakanded_paring.
     * 
    ...
    /**
     * Sets the ariregister_kasutajanimi value for this Ettevotja_esmakanded_paring.
     * 
    ...
    /**
     * Gets the ariregister_parool value for this Ettevotja_esmakanded_paring.
     * 
    ...
    /**
     * Sets the ariregister_parool value for this Ettevotja_esmakanded_paring.
     * 
    ...
    /**
     * Gets the kuupaev value for this Ettevotja_esmakanded_paring.
     * 
     * @return kuupaev   * Millise kuupäeva kohta ettevõtja esmakandeid päritakse.
     */
    ...
    /**
     * Sets the kuupaev value for this Ettevotja_esmakanded_paring.
     * 
     * @param kuupaev   * Millise kuupäeva kohta ettevõtja esmakandeid päritakse.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Ettevotja_esmakanded_paring)) return false;
        Ettevotja_esmakanded_paring other = (Ettevotja_esmakanded_paring) obj;
