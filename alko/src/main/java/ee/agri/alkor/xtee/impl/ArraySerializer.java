...
public class ArraySerializer implements Serializer
{
        ...
        throws IOException
    {
        ...
        StringBuffer sb = new StringBuffer()
        	...
        	.append(" xsi:type=\"SOAP-ENC:Array\" SOAP-ENC:arrayType=\"")
        	.append(name.getPrefix()).append(":").append(name.getLocalPart()).append("[")
        	.append(Integer.toString(len)).append("]\" SOAP-ENC:offset=\"[0]\"")
        	.append(" xmlns:").append(name.getPrefix()).append("=").append(name.getNamespaceURI())
        	.append(" xmlns:SOAP-ENC=\"http://schemas.xmlsoap.org/soap/encoding/\">");
        
        for (int index = 0; index < len; index++) {
            Object aValue = Array.get(value, index);
            sb.append("<item xsi:type=\"").append(name.getPrefix()).append(":")
            .append(name.getLocalPart()).append("\">")
