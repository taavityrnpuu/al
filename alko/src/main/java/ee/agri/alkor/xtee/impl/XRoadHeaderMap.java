...
public class XRoadHeaderMap extends HashMap {

	public XRoadHeaderMap() {
		super();
	...
	public XRoadHeaderMap(int initialCapacity, float loadFactor) {
		super(initialCapacity, loadFactor);
	}

	public XRoadHeaderMap(int initialCapacity) {
		super(initialCapacity);
	}

	public XRoadHeaderMap(Map m) {
		super(m);
	}
