 ...
 */
public class StringArraySerializerFactory extends BaseSerializerFactory {
    public StringArraySerializerFactory() {
        this(Object[].class, Constants.SOAP_ARRAY);
    }
    public StringArraySerializerFactory(Class javaType, QName xmlType) {
        super(StringArraySerializer.class, xmlType, javaType);
    }

    private QName componentType = null;
    private QName componentQName = null;

    public StringArraySerializerFactory(QName componentType) {
        super(StringArraySerializer.class, Constants.SOAP_ARRAY, Object[].class);
        this.componentType = componentType;
    }

    public StringArraySerializerFactory(QName componentType, QName componentQName) {
        this(componentType);
    ...
    protected Serializer getGeneralPurpose(String mechanismType)
    {
        ...
        if (componentType == null)
            ...
            return new StringArraySerializer(javaType, xmlType, componentType, componentQName);
    }
}
