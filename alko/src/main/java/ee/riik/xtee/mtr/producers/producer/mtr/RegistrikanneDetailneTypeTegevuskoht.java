/**
 * RegistrikanneDetailneTypeTegevuskoht.java
 *
...
public class RegistrikanneDetailneTypeTegevuskoht  extends ee.riik.xtee.mtr.producers.producer.mtr.TegevuskohtType  implements java.io.Serializable {
    private ee.riik.xtee.mtr.producers.producer.mtr.TegevuskohtType[] myygikoht;

    public RegistrikanneDetailneTypeTegevuskoht() {
    }
    ...
    /**
     * Gets the myygikoht value for this RegistrikanneDetailneTypeTegevuskoht.
     * 
     * @return myygikoht
     */
    ...
    /**
     * Sets the myygikoht value for this RegistrikanneDetailneTypeTegevuskoht.
     * 
     * @param myygikoht
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RegistrikanneDetailneTypeTegevuskoht)) return false;
        RegistrikanneDetailneTypeTegevuskoht other = (RegistrikanneDetailneTypeTegevuskoht) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegistrikanneDetailneTypeTegevuskoht.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://producers.mtr.xtee.riik.ee/producer/mtr", ">registrikanneDetailneType>tegevuskoht"));
