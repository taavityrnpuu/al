...
public class Status_t implements java.io.Serializable {
    ...
    // Constructor
    protected Status_t(java.lang.String value) {
        _value_ = value;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://producers.alkor2.xtee.riik.ee/producer/alkor2", "status_t"));
    }
    /**
