...
public class EmtabindStub extends org.apache.axis.client.Stub implements ee.riik.xtee.emta.producers.producer.emta.Emtaport {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("agriAktsiisiladu");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "keha"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "agriAktsiisiladu_paring"), ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring.class, false, false);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "paring"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "agriAktsiisiladu_paring"), ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "keha"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "agriAktsiisiladu_vastus"), ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_vastus.class, false, false);
        oper.addParameter(param);
    ...
    public EmtabindStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public EmtabindStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public EmtabindStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", ">agriAktsiisiladu_vastus>aktsiisilaod");
            cachedSerQNames.add(qName);
            cls = ee.riik.xtee.emta.producers.producer.emta.Aktsiisiladu[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "aktsiisiladu");
            qName2 = null;
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "agriAktsiisiladu_paring");
            cachedSerQNames.add(qName);
            cls = ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "agriAktsiisiladu_vastus");
            cachedSerQNames.add(qName);
            cls = ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_vastus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public void agriAktsiisiladu(ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring keha, javax.xml.rpc.holders.StringHolder andmekogu, javax.xml.rpc.holders.StringHolder asutus, javax.xml.rpc.holders.StringHolder isikukood, javax.xml.rpc.holders.StringHolder id, javax.xml.rpc.holders.StringHolder nimi, javax.xml.rpc.holders.StringHolder toimik, ee.riik.xtee.emta.producers.producer.emta.holders.AgriAktsiisiladu_paringHolder paring, ee.riik.xtee.emta.producers.producer.emta.holders.AgriAktsiisiladu_vastusHolder keha2) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://producers.emta.xtee.riik.ee/producer/emta/agriAktsiisiladu");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://producers.emta.xtee.riik.ee/producer/emta", "agriAktsiisiladu"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {keha, andmekogu.value, asutus.value, isikukood.value, id.value, nimi.value, toimik.value});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                paring.value = (ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring) _output.get(new javax.xml.namespace.QName("", "paring"));
            } catch (java.lang.Exception _exception) {
                paring.value = (ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "paring")), ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_paring.class);
            }
            try {
                keha2.value = (ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_vastus) _output.get(new javax.xml.namespace.QName("", "keha"));
            } catch (java.lang.Exception _exception) {
                keha2.value = (ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_vastus) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "keha")), ee.riik.xtee.emta.producers.producer.emta.AgriAktsiisiladu_vastus.class);
            }
        }
